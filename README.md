...
Currently, my main appointment is in the lab of Dr. Don F. Conrad at OHSU where I investigate the genomics of reproduction and genetics of infertility, focusing on testis biology.

The majority of my research is focused on the integration of high-dimensional multi-omics datasets, facilitating collaboration among interdisciplinary teams, and employing statistical inference and computational omics to advance clinical and preclinical initiatives. 

I have consistently advanced in my professional career and engaged in higher education, with a focus on statistics, machine learning, and data analytics pertinent to translational and clinical research. I have played a vital role in the design, implementation, and analysis of extensive research projects, contributing expertise in both wet lab and in silico methodologies to formulate hypotheses and transform research data into actionable insights. My experience encompasses rigorous quality control across various omics data types, thereby ensuring data integrity and reproducibility. I have performed statistical consultations and analyses for a diverse array of clinical studies and research endeavors within both academic and industrial settings, resulting in the production of comprehensive statistical analysis plans and significant biostatistical contributions to clinical development documentation, scientific publications, presentations, grants, and regulatory filings. Additionally, I take pleasure in providing technical training to individuals and teams, particularly in the effective utilization of statistical methodologies and tools for translational research. My established proficiency includes the development and leadership of teams dedicated to creating software, pipelines, and testing methodologies for the analysis and translation of extensive and complex biomedical data.  
